                ...
                <div class="py-6">
                    ...
                    <div class="hidden lg:block">
                        <div class="border-b border-gray-200">
                            <nav class="-mb-px flex space-x-8">
                                <!-- Current: "border-orange-500 text-orange-600", Default: "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700" -->
                                <a href="#"
                                   class="border-orange-500 text-orange-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                                    General
                                </a>
                    ...
                    <div class="mt-10 divide-y divide-gray-200">
                        ...
                        <div class="mt-6">
                            ...
                            <button type="button"
                                    class="bg-white rounded-md font-medium text-orange-600 hover:text-orange-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                              Update
                            </button>
                          </span>
                                    </dd>
                              ...
                              Remove
                                ...
                                <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:pt-5">
                                    ...
                                    <dd class="mt-1 flex text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                        ...
                                        <button type="button"
                                                class="bg-gray-200 relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 sm:ml-auto"
